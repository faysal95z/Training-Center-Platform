alert("Attention ! Ne transmettez JAMAIS de données personnelles !");
...
async function readResponseChunks(reader, answerBlcok) {
    ...
    while (true) {
        ...
        answerBlcok.innerHTML = converter.makeHtml(chunks);
    }
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            const gptOutput = addToLog("GPT se gratte le CPU...");
